    ...
    def get_procrank(self):
        ...
        if (lastLine.startswith('RAM:')):
            ...
            for valuePair in lastLineValuePairs:
                ...
                procrankData['data']['sum'][keyName] = float(Decimal(Decimal(keyValue[:-1])))
        ...
        if (xssSumLine.endswith('TOTAL')):
            ...
            procrankData['data']['sum']['ussTotal'] = float(Decimal(Decimal(ussTotalString[:-1])))
            ...
            procrankData['data']['sum']['pssTotal'] = float(Decimal(Decimal(pssTotalString[:-1])))
